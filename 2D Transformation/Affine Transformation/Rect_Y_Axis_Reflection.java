...
public class Rect_Y_Axis_Reflection extends Canvas {

    int x, y, width, height;

    public Rect_Y_Axis_Reflection() {
    ...
    public void paint(Graphics g) {
        ...
        g2d.drawRect(midX - x - width, midY - y, width, height); // Reflection across Y-axis
        g2d.drawString("Reflected", (midX - x - width) + width + 10, midY - y + height / 2);
    }

    public static void main(String[] args) {
        // Create a JFrame window to display the canvas
        JFrame frame = new JFrame("Rectangle Y-axis Reflection");
        Rect_Y_Axis_Reflection canvas = new Rect_Y_Axis_Reflection();
