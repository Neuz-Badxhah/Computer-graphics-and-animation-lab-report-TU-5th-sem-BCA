...
public class Rect_Origin_Reflection extends Canvas {

    int x, y, width, height;

    public Rect_Origin_Reflection() {
    ...
    public void paint(Graphics g) {
        ...
        // Draw the reflected rectangle in red (reflection through the origin)
        g2d.setColor(Color.RED);
        g2d.drawRect(midX - x - width, midY + y, width, height); // Reflection through the origin
        g2d.drawString("Reflected", (midX - x - width) + width + 10, midY + y + height / 2);
    }

    public static void main(String[] args) {
        // Create a JFrame window to display the canvas
        JFrame frame = new JFrame("Rectangle Origin Reflection");
        Rect_Origin_Reflection canvas = new Rect_Origin_Reflection();
