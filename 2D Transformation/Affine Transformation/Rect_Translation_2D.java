...
public class Rect_Translation_2D extends Canvas {

    int x, y, width, height, tx, ty;

    public Rect_Translation_2D() {
    ...
    public void paint(Graphics g) {
        ...
        // Apply the translation (tx, ty) to the rectangle
        AffineTransform translate = new AffineTransform();
        translate.translate(tx, ty); // Translate based on user input
        g2d.setTransform(translate); // Set the transformation
        g2d.setColor(Color.RED);
        g2d.draw(rect); // Draw the translated rectangle
        g2d.drawString("Translated", rect.x + rect.width + 10, rect.y + rect.height / 2);
    ...
    public static void main(String[] args) {
        ...
        JFrame frame = new JFrame("Rectangle Translation in 2D");
        Rect_Translation_2D canvas = new Rect_Translation_2D();
