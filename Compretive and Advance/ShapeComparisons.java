...
public class ShapeComparisons extends JPanel {
    ...
    protected void paintComponent(Graphics g) {
        ...
        drawMidpointCircle(g, CIRCLE_RADIUS, CENTER_X - 150, CENTER_Y - 150);
        endTime = System.nanoTime();
        textArea.append("Midpoint Circle Time: " + (endTime - startTime) + " ns\n");

        startTime = System.nanoTime();
        drawBresenhamCircle(g, CIRCLE_RADIUS, CENTER_X + 150, CENTER_Y - 150);
        endTime = System.nanoTime();
        textArea.append("Bresenham Circle Time: " + (endTime - startTime) + " ns\n");

        // Draw ellipses
        startTime = System.nanoTime();
        drawMidpointEllipse(g, ELLIPSE_A, ELLIPSE_B, CENTER_X - 150, CENTER_Y + 150);
        endTime = System.nanoTime();
        textArea.append("Midpoint Ellipse Time: " + (endTime - startTime) + " ns\n");

        startTime = System.nanoTime();
        drawBresenhamEllipse(g, ELLIPSE_A, ELLIPSE_B, CENTER_X + 150, CENTER_Y + 150);
        endTime = System.nanoTime();
        textArea.append("Bresenham Ellipse Time: " + (endTime - startTime) + " ns\n");
    }
    ...
    public static void main(String[] args) {
        JFrame frame = new JFrame("Shape Drawing Algorithms Comparison");
        ShapeComparisons panel = new ShapeComparisons();
        frame.add(panel);
